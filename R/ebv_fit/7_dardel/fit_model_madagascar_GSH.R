...
ft_M <- readRDS('../../../data/tidydata/full_M.rds')$madagascar$GSH |> drop_na() 
...
hypar_grid <- expand.grid(
  ...
  lambda           = c(0, 0.5, 1.5, 3.5),         # L2 regularization (Ridge regression)
  alpha            = c(0, 0.5, 1.5, 3.5)          # L1 regularization (Lasso regression)
)
...
# save ----------------------------------------------------------------------------------------
 ...
 saveRDS(saveList , '../../../results/results_madagascar_GSH.rds')
